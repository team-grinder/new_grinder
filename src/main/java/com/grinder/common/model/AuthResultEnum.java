...
public enum AuthResultEnum {
    ...
    //잘못된 요청
    DUPLICATE_EMAIL("400", "AUTH_006", "이미 사용중인 이메일입니다."),
    INVALID_PASSWORD("400", "AUTH_007", "비밀번호 형식이 올바르지 않습니다."),
    PASSWORD_MISMATCH("400", "AUTH_008", "비밀번호가 일치하지 않습니다."),
    MEMBER_NOT_FOUND("404", "AUTH_009", "회원 정보를 찾을 수 없습니다."),
    LOGIN_ATTEMPT_NOT_FOUND("404", "AUTH_010", "로그인 시도 기록을 찾을 수 없습니다."),
    UNSUPPORTED_AUTHENTICATION("400", "AUTH_011", "지원하지 않는 인증 타입입니다.");
